...
multi-arm bandit (MAB) algorithms can be used to answer the same questions with
...
To this end, we framed the question as a stochastic multi-arm bandit problem.
...
- **Adding worker nodes to swarm**:
  ...
  the <b>--advertise-addr</b> argument. For example:
  ```bash
...
- **Scaling the application**:
  ...
  ```
  :::
  Uvicorn has scaling built-in via the <b>--workers</b> argument. If you wanted to
